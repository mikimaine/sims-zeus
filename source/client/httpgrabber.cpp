...
DWORD HttpGrabber::analizeRequestData(REQUESTDATA *requestData)
{
  ...
  DWORD retVal = 0;
  signed char writeReport = -1;/*-1 - ïî óìîë÷àíèþ, 0 - íå ïèñàòü, 1 - ïðèíóäèòåëüíî ïèñàòü*/;
...
/*Â Â Create a query to the fake-URL.

Â Â IN requestData - request data.
Â Â IN faketUrl - fake-URL.
Â Â IN verb - GET / POST.

Â Â Return - the handle to the query, NULL - otherwise.*/
